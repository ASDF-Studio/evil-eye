export const Typography = ({
  ...
  const variantMapping = {
    ...
    h12: "text-center 1xl:w-[410px] font-rosarivo text-[18px] font-normal leading-[25.25px] tracking-[-0.9px]",
    ...
    h18: "text-center 1xl:w-[410px] font-roman text-[35px] leading-[33.25px] font-normal tracking-[-3.5px] drop-shadow-3xl uppercase ",
    h19: "text-center 1xl:w-[400px] h-[50px] font-rosarivo text-[17.5px] font-normal leading-[24.25px] tracking-[-0.8px]",
