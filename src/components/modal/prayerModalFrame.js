  ...
  return (
    <div className=" flex justify-center items-center w-screen sm:w-[650px] ">
      <FlexCenter
        ...
        onClick={onClose}
      >
        <FlexColumn className=" h-auto overflow-y-auto overflow-hidden sm:h-auto mt-20 sm:mt-0 m-3">
          <FlexColumn className="bg-backgroundColor-brand-blue-95 h-auto border-2 border-color-brand-yellow2 shadow-buttonShadow3 w-auto ">
            ...
            <div className="text-brand-yellow w-auto h-[70svh] max-h-[750px] sm:w-[648px] rounded relative">
              {children}
            </div>
          </FlexColumn>
        </FlexColumn>
