...
const PaymentSuccessReciteModal = ({
  ...
  return (
    <FlexCenter
      className="z-50 fixed left-[50%] bg-black bg-opacity-25 backdrop-blur-sm shadow-sm top-[50%] sm:top-[50%]"
      id="wrapper"
      onClick={handleClose}
    >
            ...
            <FlexColumn className="mb-3.5 gap-2">
              <div className="flex justify-center pt-5">
                <Typography variant="h13" classname="text-color-brand-yellow2">
                  We have successfully processed your payment. Please click
                  below to continue.
                </Typography>
              </div>
              <div className="">
